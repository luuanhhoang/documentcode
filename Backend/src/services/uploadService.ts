...
const makeStorage = (directory: string) =>
  multer.diskStorage({
...
export const avatarPublicPath = (fileName: string) => `/api/media/avatars/${fileName}`;
export const coupleAvatarPublicPath = (fileName: string) => `/api/media/couple-avatars/${fileName}`;
export const avatarFilePath = (fileName: string) => path.join(avatarUploadDir, fileName);
export const coupleAvatarFilePath = (fileName: string) => path.join(coupleAvatarUploadDir, fileName);
